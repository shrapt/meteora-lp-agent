...
def strategy(
    ...
    Key changes from commit 32:
    - Increased minimum rebalance interval from 3 steps to 4 steps to reduce transaction costs
    - Increased drift threshold from 40% to 45% of range width to capture longer trends
    - More conservative rebalancing reduces churn while maintaining capital efficiency
    """
    ...
    if step == 0:
        ...
        # (increased from 40% to reduce rebalancing frequency and transaction costs)
        ...
        # (increased from 3 steps to reduce transaction costs while maintaining responsiveness)
