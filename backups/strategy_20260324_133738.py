...
def strategy(
    ...
    """Volatility & volume-adaptive LP strategy with refined volatility dampening.

    Key changes from commit 78:
    - Further refined volatility dampening curve: more aggressive reward for very low vol
    - Smoothed transition from low to moderate volatility
    - Adjusted vol thresholds (0.020 → 0.030 for very low vol boundary)
    - This maximizes capital deployment in calm markets while protecting in volatile ones
    """
