...
def strategy(
    ...
    Key changes from commit 17:
    - Replaced displacement-ratio rebalancing with drift-based approach
    - Only rebalance when price drifts beyond 50% of current range width
    - Increased minimum rebalance interval to 5 steps to reduce churn
    - More conservative capital deployment to avoid over-extension
    """
    ...
    base_capital = 0.92  # Slightly more conservative than before
