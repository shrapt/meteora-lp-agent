...
def strategy(
    ...
    """Volatility & volume-adaptive LP strategy with refined proximity bonus.
    ...
    capital_fraction = max(0.78, min(1.12, capital_fraction))  # Increased upper bound to 1.12 from 1.10
