...
def strategy(
    ...
    """Volatility & volume-adaptive LP strategy with squared volatility penalty.

    Key changes from commit 12:
    - Changed volatility penalty from linear to squared term: -0.18 * (recent_vol / 0.05)**2
    - This provides more aggressive capital deployment at low volatility (0-2% vol)
    - While being more conservative at moderate-to-high volatility (3%+ vol)
    - Should better balance fee capture with capital preservation
    """
