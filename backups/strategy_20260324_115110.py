...
def strategy(
    ...
    - Rebalance threshold now adapts to recent volatility: tighter in low-vol, looser in high-vol
    - This reduces unnecessary rebalancing in stable conditions while allowing drift in volatile ones
    - Threshold ranges from 35% (vol=0.01) to 55% (vol=0.08) of range width
    """
    ...
    capital_fraction = max(0.76, min(1.0, capital_fraction))
