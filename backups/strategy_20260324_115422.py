...
def strategy(
    ...
    Key changes from commit 63:
    - Increased base capital deployment from 0.96 to 0.97
    - Changed volatility penalty to use square-root dampening (softer curve)
    - This allows more aggressive deployment during moderate vol while protecting against spikes
    - Maintains tight bounds on capital_fraction (0.78 to 1.0)
    """
    ...
    base_capital = 0.97  # Increased from 0.96
    ...
    capital_fraction = max(0.78, min(1.0, capital_fraction))  # Tighter bounds
