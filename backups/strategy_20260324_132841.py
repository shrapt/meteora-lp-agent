...
def strategy(
    ...
    - Increased minimum rebalance interval from 4 to 5 steps to reduce unnecessary rebalancing
    - Slightly relaxed capital deployment ceiling from 1.05 to 1.08 in very calm markets
    - This reduces gas costs from excessive rebalancing while capturing more upside in low-vol periods
    """
